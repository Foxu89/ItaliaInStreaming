...
class StreamHGExtractor : ExtractorApi() {
    ...
    override val mainUrl = "dhcplay.com"
    ...
    companion object {
        ...
        private fun isTargetUrl(url: String): Boolean {
            ...
            return lowerUrl.contains("/stream/") && lowerUrl.contains("master.m3u8")
        }
    }
    ...
    override suspend fun getUrl(
        ...
        Log.d(TAG, "Sniffing StreamHG: $url")

        val videoUrl = extractWithWebView(url)

        if (videoUrl != null) {
            val refererDomain = try {
